...
elseif(OPUS_CPU_ARM AND NOT OPUS_DISABLE_INTRINSICS)
  ...
  if(COMPILER_SUPPORT_NEON AND NOT OPUS_CPU_ARM_MS)
    opus_detect_dotprod(COMPILER_SUPPORT_DOTPROD)
    if(COMPILER_SUPPORT_DOTPROD)
      option(OPUS_MAY_HAVE_DOTPROD "Does runtime check for dotprod support" ON)
    endif()
  endif()
endif()
